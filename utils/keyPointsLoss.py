...
class ComputeLoss:
    ...
    def build_targets(self, p, targets):
        ...
        for i in range(self.nl):
            ...
            indices.append((
                b,  # Assuming b is already an int or long type
                a,  # Assuming a is already an int or long type
                gj.clamp(0, gain[3] - 1).long(),  # Use clamp instead of clamp_
                gi.clamp(0, gain[2] - 1).long()  # Use clamp instead of clamp_
            ))
